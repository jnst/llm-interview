...
export default function Progress() {
  ...
  useEffect(() => {
    ...
    // 期間フィルター（簡易実装）
    const filteredStats =
      defaultStudyManager.calculateStudyStats(filteredInterviews)
                  ...
                  {[
                    ...
                    <button
                      ...
                      onClick={() =>
                        setFilters((prev) => ({
                          ...prev,
                          period: value as "week" | "month" | "all",
                        }))
                      }
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div className="text-center">
                  <div className="text-2xl font-bold text-success">
                    {filteredStats?.categoryProgress.reduce(
                      (sum, cp) => sum + cp.masteredCards,
                      0
                    ) || 0}
                  </div>
                  <div className="text-sm text-gray-600 dark:text-gray-400">
            ...
            <Card>
              <div className="space-y-4">
                ...
                <div className="text-center py-8">
                  ...
                  <div className="text-sm text-gray-400 mt-2">実装予定</div>
                </div>
              </div>
            </Card>
          </div>
                  ...
                  return (
                    <div key={progress.category} className="space-y-2">
                      <div className="flex items-center justify-between">
                        ...
                        <div className="text-sm text-gray-600 dark:text-gray-400">
                          {progress.masteredCards}/{progress.totalCards} (
                          {masteryPercent}%)
                        </div>
                      </div>
